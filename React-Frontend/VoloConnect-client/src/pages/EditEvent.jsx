    ...
    const fetchEvent = () => {
      ...
      try {
        ...
        setFormData({
          ...event,
          date: formattedDate,
          volunteersRequired: event.volunteersRequired.toString()
        });
      } catch (error) {
            ...
            <Card>
              <form onSubmit={handleSubmit}>
                <CardHeader>
                  ...
                  <CardDescription>
                    Update the details of your volunteer event
                  </CardDescription>
                </CardHeader>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div className="space-y-2">
                      ...
                      <p className="text-xs text-muted-foreground">
                        Note: If you reduce this number and there are already volunteers registered,
